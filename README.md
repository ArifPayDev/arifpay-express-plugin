...
```
cd existing_repo
git remote add origin https://gitlab.arifpay.org/Ananiya/arifpay-express-plugin.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.arifpay.org/Ananiya/arifpay-express-plugin/-/settings/integrations)
